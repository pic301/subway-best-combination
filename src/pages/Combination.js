...
class Combination extends Component {
  state = {
    ...
    cardDesc: [
      "매장에서 직접 구운 6가지 종류 중 고객님이 원하는 빵으로 추가비용없이 선택가능합니다.",
      " 나만의 메뉴를 더욱 풍성하게 즐기세요.",
      "원하지 않는 야채는 뺴고 좋아하는 야채를 더하세요.",
      "풍미를 더해주는 치즈를 골라주세요.",
      ...
      <div className="combination">
        <div className="combination-wrapper">
          <div className="combination-content">
            ...
            <div className="step-content">
              ...
              <div className="step-card-right">
                ...
                <div className="step-menu">
                  <strong>{this.state.cardTitle[this.state.step]}</strong>
                </div>
            ...
            <button className="btn btn-prev" onClick={this.prevStep}>
              이전
            </button>
